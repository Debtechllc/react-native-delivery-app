...
import { MY_CART_REQUEST } from '../config/serveraction'
import { NavigationActions } from 'react-navigation';

function requestForGetCart(data) {
    return {
        type: REQUEST_MY_CART,
        payload: { data },
    }
}
...
function getCart(data) {
    return dispatch => {
        ...
        return fetch(WEBSERVICE_URL + MY_CART_REQUEST, {
            method: 'POST',
            headers: {
...
function fetchGetCartIfNeeded(data) {
