...
import { fetchGetCartIfNeeded } from '../actions'
...
class MyCartScreen extends Component {
    ...
    componentDidMount(prevProps, prevState, snapshot) {
        if (this.props.curState.Login_Reducer && this.props.curState.Login_Reducer.user && this.props.curState.Login_Reducer.user.id) {
            ...
            this.props.fetchGetCartIfNeeded(data)
        }
        else{
    ...
    render() {
        ...
        console.warn(this.props.curState.My_Cart_Reducer.my_cart);
        if (this.props.curState.My_Cart_Reducer.my_cart.jsonresp ) {
            addToCartData = this.props.curState.My_Cart_Reducer.my_cart.jsonresp
            console.warn("Error for the responce " + addToCartData.error);
       }
