...
class HomeLatestProducts extends Component {
  ...
  render() {
    ...
    return (
        ...
        <View style={{ position: 'absolute', flex: 1, top: 90, left: 5, right: 5, bottom: 10, backgroundColor: 'white', shadowColor: '#000000',
    shadowOffset: {
      width: 0,
      height: 3
    },
    shadowRadius: 5,
    shadowOpacity: 0.4, elevation: 1, justifyContent:'center'}}>
